        ...
        <div class="bg-white p-10 rounded-[2.5rem] border border-slate-50 shadow-sm transition-all hover:shadow-md">
          ...
          <div class="space-y-8">
            <div>
              ...
              <input type="text" placeholder="Contoh: Eotech Music Festival 2024" 
            ...
            <div>
              ...
              <div class="border border-slate-100 rounded-[1.5rem] bg-white overflow-hidden group focus-within:border-[#0D4433] focus-within:ring-4 focus-within:ring-[#0D4433]/5 transition-all shadow-sm">
                ...
                <textarea rows="8" placeholder="Ceritakan detail event Anda di sini..." 
          ...
          <div class="space-y-8">
            <div class="grid grid-cols-2 gap-8">
              <div>
                ...
                <input type="date" class="w-full bg-[#F1F5F9]/60 border border-slate-100 rounded-xl py-4.5 px-6 text-sm text-slate-600 outline-none focus:bg-white focus:border-[#0D4433]" />
              </div>
              <div>
                <label class="block text-[13px] font-[700] text-slate-700 mb-2.5">Waktu Mulai <span class="text-rose-500">*</span></label>
                <input type="time" class="w-full bg-[#F1F5F9]/60 border border-slate-100 rounded-xl py-4.5 px-6 text-sm text-slate-600 outline-none focus:bg-white focus:border-[#0D4433]" />
              </div>
            </div>
            
            <div>
              <label class="block text-[13px] font-[700] text-slate-700 mb-2.5">Nama Lokasi <span class="text-rose-500">*</span></label>
              <input type="text" placeholder="Gedung, Mall, atau Nama Tempat" class="w-full bg-[#F1F5F9]/60 border border-slate-100 rounded-[1.25rem] py-5 px-6 text-[15px] text-slate-700 font-medium outline-none focus:bg-white focus:border-[#0D4433]" />
            </div>
        ...
        <div class="bg-white p-10 rounded-[2.5rem] border border-slate-50 shadow-sm transition-all hover:shadow-md">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input type="text" placeholder="Nama Komunitas/PT" 
            ...
            <div>
              ...
              <input type="text" placeholder="0812xxxxxx" 
                class="w-full bg-[#F1F5F9]/60 border border-slate-100 rounded-[1.25rem] py-5 px-6 text-[15px] text-slate-700 font-medium outline-none focus:bg-white placeholder:text-slate-300" />
            </div>
          </div>
        </div>
      ...
      <div class="lg:col-span-4 space-y-8 sticky top-28">
        ...
        <div class="bg-white p-8 rounded-[2.5rem] border border-slate-50 shadow-sm">
          ...
          <div class="relative bg-[#D1D5DB] rounded-[2rem] p-5 border border-slate-200 overflow-hidden shadow-inner group cursor-pointer hover:border-[#0D4433]/30 transition-all duration-500">
             <div class="bg-white rounded-2xl py-14 flex flex-col items-center justify-center text-center space-y-5 border border-dashed border-slate-100">
        ...
        <div class="bg-white p-8 rounded-[2.5rem] border border-slate-50 shadow-sm space-y-8">
          ...
          <div class="space-y-4">
            <label class="flex items-center p-5 bg-[#F1F5F9] border-2 border-transparent hover:border-[#0D4433]/10 rounded-[1.5rem] cursor-pointer transition-all">
              <input type="radio" name="status" checked class="w-6 h-6 text-[#0D4433] border-slate-300 focus:ring-0 cursor-pointer mr-5" />
              <div>
            ...
            <label class="flex items-center p-5 bg-white border-2 border-slate-50 hover:border-[#0D4433]/10 rounded-[1.5rem] cursor-pointer transition-all shadow-sm">
              <input type="radio" name="status" class="w-6 h-6 text-[#0D4433] border-slate-300 focus:ring-0 cursor-pointer mr-5" />
              <div>
          ...
          <button class="w-full bg-[#0D4433] text-white py-5 rounded-[1.5rem] font-[700] text-[15px] shadow-xl shadow-[#0d4433]/20 hover:bg-[#0a3528] active:scale-[0.98] transition-all flex items-center justify-center tracking-wide">
            Simpan
          </button>
